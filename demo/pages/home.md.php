...
$flag = HttpFundamental\Request::NO_REWRITE;
$protocol = 'http';
$method = 'get';
$headers = null;
$get = array(
...
$files = null;
$cookies = null;
$custom_request = HttpFundamental\Request::create(
...
$custom_request->setFlag(HttpFundamental\Request::REWRITE_SEGMENTS_QUERY);
...
### HttpFundamental\Response

```php
$response = new \HttpFundamental\Response();
<?php
$response = new \HttpFundamental\Response();
var_export($response);
?>
